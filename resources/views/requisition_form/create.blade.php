      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control" name="folio_number" id="folio_number" type="integer"></input></div>
            ...
            <div class="col-md-6">
              ...
              <input class="form-control" name="unit_cost" id="unit_cost" type="integer"></input></div>

              <div class="form-group">Acknowledgment</div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input class="form-control" type="text" name="Name" value="Full Names">
                <label for="title">Title::</label>
                <input class="form-control" type="text" name="title" value="job title"><br>

                <div class="col-md-6">
                  <a href="{{url('/requisition_form.index')}}" class="btn btn-default">Cancel</a>
