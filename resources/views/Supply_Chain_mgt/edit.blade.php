...
<div class="page_content">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">Update Equipment Information</div>

                <div class="panel-body">
                    {!! Form::model($asset_mgt, array('route' => array('asset_mgt.edit', $asset_mgt),'autocomplete' => 'off', 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'method' => 'PUT')) !!}
