                              ...
                              <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <label for="dept">Received BY::</label>
                                    <label for="dept">Name::</label>
                                    <input class="form-control" type="text" name="Name" value="Full Names">
                                    <label for="dept">Signature::</label>
                                    <input class="form-control" type="text" name="Name" value="Signature"> </div>
