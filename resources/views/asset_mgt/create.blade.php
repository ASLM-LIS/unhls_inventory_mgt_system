                  ...
                  <link rel="stylesheet" href="//code.jquery.com/ui/1.11.2/themes/smoothness/jquery-ui.css">
                    <div class="row">
                        ...
                        <div <ol class="breadcrumb">
                          ...
                          <li><a class="active"> Add New Asset/a></li>
                            </div>
                            ...
                            <fieldset>
                              ...
                              <div class="form-group">
                                ...
                                <label for="" class="required">Asset Name</label>
                                    <input class="form-control" name="Asset_name" id="Asset_name" type="text"></input>
                              </div>
                              <div class="form-group">
                                <label for="Asset_Type">Asset Type</label>
                                <input class="form-control" name="Asset_Type" id="Asset_Type" type="text"></input>
                              </div>
                              <div class="form-group">
                                <label for="Asset_Category" class="required">Asset Category</label>
                                <input class="form-control" name="Asset_Category" id="Asset_Category" type="text"></input>
                              </div>
                              <div class="form-group">
                                <label for="Serial_number" class="required">SerialNo.</label>
                                <input class="form-control" name="Serial_numbert" id="Serial_number" type="text"></input>
                                </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input class="form-control" name="department" id="department" type="text"></input>
                              </div>
