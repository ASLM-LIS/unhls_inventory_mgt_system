...
<div class="page_content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      {{ Form::open(array('url' => 'asset_mgt/' . $asset_mgt->id, 'class' => 'form-view')) }}
                      {{ Form::hidden('_method', 'SHOW') }}
                      {{Form::button('<span class="ion-eye"> </span>View', array('type' => 'submit', 'class' => 'btn btn-md btn-info', 'name' => 'delete_modal'))}}


                  {{ Form::open(array('url' => 'asset_mgt/' . $asset_mgt->id, 'class' => 'form-delete')) }}
                  {{ Form::hidden('_method', 'DELETE') }}
                  {{Form::button('<span class="ion-trash-a"> </span>Delete', array('type' => 'submit', 'class' => 'btn btn-md btn-danger', 'name' => 'delete_modal'))}}
